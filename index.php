...
<body>
    <div class="container px-4 py-5" id="custom-cards">
        <h2 class="pb-2 border-bottom">PRESTASI HOMEBASE</h2>

        <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
            <div class="col">
                <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('https://img-cdn.hltv.org/gallerypicture/9tsP5rLIdqMavb1yFXyTFL.jpg?auto=compress&ixlib=java-2.1.0&q=75&w=800&s=092e666315aafab6555a5bc59b301917');">
                    <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                        <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Achievement Record</h3>
                        <a href="prestasi.php" class="btn btn-primary">Go somewhere</a>
                    </div>
                </div>
            </div>
